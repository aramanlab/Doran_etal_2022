...
@everywhere include(srcdir("neighborjoining.jl"))
@everywhere using Main.NeighborJoining
...
function julia_main()::Cint
    ...
    if args.nboot > 0
        @info "Starting Bootstrap with $(args.nboot) bootstraps across $(nworkers()) processes"
        @time begin

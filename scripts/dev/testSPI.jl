...
ARGS = [
    # "-i", "data/exp_raw/toyMSAs/18x9MSA.phy", 
    "-i", "data/sims/MSAs/gtdb-g__Halomonas_E-t16-l1000-b20.phy", 
    "-o", "_research/testSPI/gtdb-g__Halomonas_E-t16-l1000-b20"
]
# function julia_main()::Cint
    ...
    hij = pairwise(Hamming(), permutedims(_stringcolumntocharmtx(phydf.seqs)));
    heatmap(hij, ticks=1:16)
